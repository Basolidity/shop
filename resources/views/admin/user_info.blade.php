...
@section('center')
    ...
    <div class="x-body">
        ...
        <xblock>
            ...
            <button class="layui-btn" onclick="xadmin.add_tab('添加用户','{{ url('admin/info/create') }}',600,400)">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <a title="编辑" onclick="xadmin.add_tab('编辑','/admin/info/{{$v['id']}}/edit',600,400)" href="javascript:;">
