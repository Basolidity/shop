    ...
    <body style="padding:20px 20px">
            ...
            <form class="layui-form layui-col-md12  layui-form-pane"action="javascript:;" id="formdate">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="lname"  lay-verify="required" autocomplete="off" class="layui-input" value="{{ $rs->lname }}"></div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="phone"  lay-verify="phone" autocomplete="off" class="layui-input" value="{{ $rs->phone }}"></div>
                    <div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="uname" name="postal" autocomplete="off" class="layui-input" placeholder="000000" value="{{ $rs->postal }}"></div>
                    <div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:500px">
                        <input type="text"  name="path"  lay-verify="required" autocomplete="off" class="layui-input" value="{{ $rs->path }}"></div>
                    <div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>
                    </div>
                </div>
        ...
        <script>
            ...
            layui.config({
                ...
                currentPicker.setValue("{{ $rs->area }}");
            });
        </script>
        <script>
